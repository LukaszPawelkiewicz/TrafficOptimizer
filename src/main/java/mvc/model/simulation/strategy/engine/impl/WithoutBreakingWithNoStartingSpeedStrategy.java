...
public class WithoutBreakingWithNoStartingSpeedStrategy implements EngineStrategy {

    @Override
    public UniformModel moveSimulation(UniformModel model, Vehicle vehicle) {
        model.setStartingSpeed(vehicle.getCurrentSpeed());
        UniformStrategy uniformStrategy = new UniformlyAcceleratedWithNoStartingSpeedStrategy();
